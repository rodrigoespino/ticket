...
class bugs extends Admin_Controller {
	...
	{
	$crud = $this->generate_crud('bugs');

		$crud->fields('id_bugs','dataopen','dateclose','subject','message','file','id_status','id_depts','id','id_prio');

		$crud->unset_add();
		$crud->unset_delete();

		$this->mPageTitle = 'Bugs';
		$this->render_crud();
}
public function depbugs()
	{
...
public 	function open_bugs()
{
	$crud = $this->generate_crud('bugs');
    $crud->set_theme('datatables');
 	$crud->fields('id_bugs','dataopen','dateclose','subject','message','file','id_status','id_depts','id','id_prio');
	 $crud->set_subject('subject');
	$this->mPageTitle = 'Open BUGS';
...
function update_history_bugs($post_array,$row)
{
